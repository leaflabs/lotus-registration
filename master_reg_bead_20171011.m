...
if ~isempty(strfind(param.hostname, 'Justins-Mac'))
	...
	param.ipath = [param.ppath '/bead/20171011']
...
elseif ~isempty(strfind(param.hostname, 'willis'))
	...
	addpath([param.ppath '/lotus-registration']);
    	param.ipath = '/om/user/jkinney/DLFM/bead/20171011'
	param.opath = [param.ppath '/bead/20171011']
end
...
register(param)
close all;
param.inputFileName = {'Recon3D_1_med_Mono_N15.mat'};
register(param)
close all;
